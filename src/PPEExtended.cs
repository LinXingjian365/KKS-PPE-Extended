...
{
    [BepInPlugin("com.user.ppe_extended", "PPE Extended (Full PPSv2)", "2.0.0")]
    ...
    public class PPEExtended : BaseUnityPlugin
    {
        ...
        private static MemberInfo _aoMode, _aoModeSel, _aoFold, _aoObj, _cgFold, _lift, _gamma, _gain, _cgObj, _toneMap, _ppVolume;
        ...
        private void Awake()
        {
            ...
            _toneMap = GM(_ppeType, "CGtoneMapper"); _ppVolume = GM(_ppeType, "postProcessVolume");
            ...
            Logger.LogInfo("PPE Extended v1.4.2 loaded - Ctrl+P to open panel");
        }
        ...
        private void OnGUI()
        {
            ...
            _windowRect = GUILayout.Window(_windowId, _windowRect, DrawWindow, "PPE Full PPSv2 Color Panel v1.4  [Ctrl+P]", GUILayout.Width(360));
        ...
        static void UpdatePostfix(object __instance)
        {
            try
            {
                ...
                var vol = (PostProcessVolume)GMV(_ppVolume, __instance);
